...
export const LandingProductFeature = ({
  ...
  return (
    ...
    >
      <div
        className={clsx('w-full p-6 flex flex-col items-center relative', imagePosition === 'center' ? 'container-narrow' : 'max-w-full container-wide grid lg:grid-cols-2', innerClassName)}
        style={{
          minHeight,
        }}
      >
        <div className={clsx('flex flex-col gap-4', imagePosition === 'left' && 'lg:col-start-2 lg:row-start-1', textPosition === 'center' ? 'md:max-w-lg items-center text-center' : 'items-start')}>
          {title ? <h2 className="text-4xl font-semibold leading-tight">{title}</h2> : titleComponent}
            ...
            {imagePosition === 'left' || imagePosition === 'right' ? (
              <Image
                className={clsx(
                  ...
                  imagePerspective === 'paper' && 'lg:perspective-paper hover:scale-90',
