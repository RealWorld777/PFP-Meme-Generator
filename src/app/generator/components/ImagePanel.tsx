  ...
  return (
    <div ref={captureRef} className="relative border-2 border-black w-full md:w-[400px] md:h-[400px] aspect-square">
      ...
      {shareUrl && allImagesLoaded && (
        <ShareButton url={shareUrl} title="Check out this awesome $CFB PFP I just created! #CFBGENERATOR @c_f_b_token" className="absolute bottom-2 right-2 hover:scale-110 transition duration-200" />
      )}
    </div>
  );
};
